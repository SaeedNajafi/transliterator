...
# note that it uses the folds 0-7 training set ***
...
cp  ../Folds/$lower.0-7.tst  $lower.trn.noprocessing # the noprocessing files are used when finding supplemental data for getSUpp.py script
