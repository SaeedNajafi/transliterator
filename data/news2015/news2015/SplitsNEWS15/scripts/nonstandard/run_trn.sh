...
~/DirecTL-p-3j-speedup-general/directlp -f $lower.align  --inChar : --extFeaTrain $lower.trn.ext --order 1 --linearChain  --jointMgram 5 --mo /local/chauvin1/ajstarna/$lower/$lower.0-7Model