...
jointGenAllSystems.tst.sh ${LOWER}.dev ${LOWER}Dev.phraseOut ${LOWER}.dev.seq.out ${UPPER}.dev.smt.out ${LOWER} ${LOWER}.full.trn.m-mAlign.1-2.delX.1-best.conYX.align.10nBest.1order.linearChain.${MODELNUM} $TAGS
