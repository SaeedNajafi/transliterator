Evaluation script news_evaluation.py reads transliteration results file and test file in XML format according to the specification in the NEWS whitepaper. The following metrics are calculated:
1) ACC: Accuracy in top-1, or word error rate.
2) Fuzziness in top-1, or mean F-score.
3) Mean Reciprocal Rank (MRR)
4) Mean Average Precision MAP_ref

For detailed description of each metric please refer to the NEWS whitepaper.
...
If you have any questions regarding the evaluation script or would like to report a bug, please contact us at mliu@i2r.a-star.edu.sg
